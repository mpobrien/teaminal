...
BasicScreen.prototype.softterminalreset = function(params){//{{{
    this.reset()
}//}}}
...
BasicScreen.prototype.cursorcharabs = function(params){//{{{
    var charpos = 0
    if(params.length > 0){
        charpos = params[0] - 1
    }
    this.cursor.x = charpos;
    this.ensureBounds();
}//}}}
...
BasicScreen.prototype.defaultcharset = function(params){
    this.debug("defaultcharset!", params); //@debug
}
